// npc-character-config.js
// NPC/character pose and tuning data. No camera logic.

export const CHILD_POST_TALK_ARMS={
  active:false,
  startTime:0,
  duration:1900,
  child:null,
...
export const SECURITY_POST_TALK_ARMS={
  active:false,
  startTime:0,
  duration:2200,
  security:null,
...
export const SECURITY_GAME_START_SNAPSHOT={
  captured:false,
  position:null,
  rotation:null,
  scale:null,
...
export const THIEF_HANDCUFF_EDITOR={
  panel:null,
  readout:null,
  bones:{},
  rest:{},
...
export const FINAL_SCENE_LOCKED_LAYOUT={
  player:{
    x:-51.235,
    y:0.135,
    z:86.146,
...
export const LEFT_ROSE_GROUP_MIRROR={
  x:-1.000,
  y:0,
  z:0,
  scaleX:1,
...
export const NPC_RELEVANCE_CONFIG={
  nearDistance:25,
  mediumDistance:60,
  farDistance:120,
  nearEvery:1,
